...
/*
	PostResetPassword swagger:route POST /resetPassword postResetPassword
...
func (o *PostResetPasswordBody) validateNewPassword(formats strfmt.Registry) error {
...
func (o *PostResetPasswordBody) validateOldPassword(formats strfmt.Registry) error {

	if err := validate.Required("data"+"."+"oldPassword", "body", o.OldPassword); err != nil {
		return err
	}
